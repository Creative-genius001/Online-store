						...
						<div className="w-[70%] mx-auto mt-4 flex  justify-between items-start mb-16 ">
							...
							<div className="flex flex-col">
								...
								<button
									...
									className=" mt-2 bg-[#FE6263] w-auto px-4 h-[40px] cursor-pointer text-white font-medium text-[0.8rem] flex items-center transition-all ease-in-out  hover:bg-neutral-900">
									Proceed to Checkout{" "}
									<BsArrowRightShort />
								</button>
							</div>
